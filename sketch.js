...
function draw (){
    ...
    if(gameState===4){
        ...
        dustStorm.velocityY = -3;
        dustStorm.bounceOff(wall2);
        if(neil.isTouching(wall1)){
            neil.bounceOff(wall1);
        }
        if(neil.isTouching(wall2)){
            neil.bounceOff(wall2);
        }
        if(neil.isTouching(wall2)){
            neil.bounceOff(wall2);
        }
        if(neil.isTouching(wall3)){
            neil.bounceOff(wall3);
        }
        if(neil.isTouching(wall4)){
            neil.bounceOff(wall4);
        }
        if(neil.isTouching(wall5)){
            neil.bounceOff(wall5);
        }
        if(neil.isTouching(wall6)){
            neil.bounceOff(wall6);
        }
        if(buzz.isTouching(wall1)){
            buzz.bounceOff(wall1);
        }
        if(buzz.isTouching(wall2)){
            buzz.bounceOff(wall2);
        }
        if(buzz.isTouching(wall3)){
            buzz.bounceOff(wall3);
        }
        if(buzz.isTouching(wall4)){
            buzz.bounceOff(wall4);
        }
        if(buzz.isTouching(wall5)){
            buzz.bounceOff(wall5);
        }
        if(buzz.isTouching(wall6)){
